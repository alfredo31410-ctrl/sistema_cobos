        ...
        <div className="page-container relative z-10 py-10 sm:py-14 lg:py-16 xl:py-20">
          <div className="grid items-start gap-8 lg:grid-cols-12 lg:gap-10 xl:gap-14">
            ...
            <div className="order-1 lg:order-2 lg:col-span-7">
              ...
              <div className="mt-7">
                <div className="inline-flex min-h-[60px] w-full max-w-[420px] items-center justify-center rounded-2xl border border-white/15 bg-white/10 px-6 py-4 text-base font-black uppercase text-white/90 shadow-[0_18px_45px_rgba(12,18,38,0.35)] backdrop-blur-sm sm:px-8 sm:py-5 sm:text-lg">
                  Próximamente
                </div>
              </div>
              ...
              <div className="mt-7 inline-block rounded-xl bg-[#2563eb] px-5 py-3 shadow-lg shadow-blue-950/20">
                <p className="text-sm font-black uppercase tracking-wide sm:text-base">
                  Estamos preparando la siguiente edición
                </p>
              </div>
              ...
              <div className="mt-7">
                ...
                <p className="mt-3 flex items-center gap-2 text-xl font-bold text-white sm:text-2xl">
                  ...
                  <span className="inline-block h-3 w-3 rounded-full bg-amber-400 shadow-[0_0_16px_rgba(251,191,36,0.9)]" />
                </p>
              </div>
        ...
        <div className="page-container">
          <div className="flex flex-wrap justify-center gap-5 text-white sm:gap-6 lg:gap-12">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-sm font-semibold sm:text-base">
                Avisaremos pronto la próxima edición
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-xl text-center">
            ...
            <div className="rounded-2xl bg-[#0f1d3d] p-5 shadow-2xl sm:rounded-3xl sm:p-6 lg:p-8 xl:p-10">
              ...
              <p className="mb-6 text-sm text-neutral-400 sm:mb-8 sm:text-base">
                Estamos preparando la siguiente edición en vivo.
              </p>

              <div className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/10 px-6 py-3 font-semibold text-white/90">
                Próximamente
              </div>
            </div>
          </div>
        ...
        <div className="page-container">
          <div className="flex flex-wrap justify-center gap-5 text-white sm:gap-6 lg:gap-12">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Clock className="h-4 w-4 sm:h-5 sm:w-5" />
              <span className="text-sm font-semibold sm:text-base">
                Nueva convocatoria por anunciar
              </span>
            </div>
          </div>
        </div>
