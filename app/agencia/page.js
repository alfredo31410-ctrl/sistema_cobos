        ...
        <div className="page-container py-14 sm:py-16 lg:py-24">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mx-auto mb-6 sm:mb-8 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full bg-cefin-red/20">
              <Building2 className="h-8 w-8 sm:h-10 sm:w-10 text-cefin-red" />
            </div>
          ...
          <div className="mx-auto max-w-3xl">
            <div className="rounded-2xl sm:rounded-3xl border-2 border-dashed border-neutral-300 bg-neutral-50 p-6 sm:p-8 lg:p-12 xl:p-16 text-center">
              <div className="mx-auto mb-6 sm:mb-8 flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full bg-neutral-200">
                <Building2 className="h-10 w-10 sm:h-12 sm:w-12 text-neutral-400" />
              </div>
              ...
              <div className="inline-flex items-center gap-2 rounded-full bg-neutral-900 px-5 sm:px-6 py-3 text-white">
                ...
                <span className="text-sm sm:text-base font-medium">Próximamente</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="page-container">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 sm:gap-8">
              <div className="rounded-2xl bg-white p-6 sm:p-7 text-center shadow-sm border border-neutral-100">
                <div className="mx-auto mb-5 sm:mb-6 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-neutral-50 shadow-sm">
                  <span className="text-2xl sm:text-3xl font-bold text-cefin-red">1</span>
                </div>
                <h3 className="mb-2 text-lg sm:text-xl font-bold text-neutral-900">
                  Consulta
                </h3>
                <p className="text-sm sm:text-base text-neutral-600">
                  Analizamos tu conocimiento y definimos la estrategia
                </p>
              </div>

              <div className="rounded-2xl bg-white p-6 sm:p-7 text-center shadow-sm border border-neutral-100">
                <div className="mx-auto mb-5 sm:mb-6 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-neutral-50 shadow-sm">
                  <span className="text-2xl sm:text-3xl font-bold text-cefin-red">2</span>
                </div>
                <h3 className="mb-2 text-lg sm:text-xl font-bold text-neutral-900">
                  Construcción
                </h3>
                <p className="text-sm sm:text-base text-neutral-600">
                  Creamos tu oferta, tu embudo y tu sistema
                </p>
              </div>

              <div className="rounded-2xl bg-white p-6 sm:p-7 text-center shadow-sm border border-neutral-100 sm:col-span-2 lg:col-span-1">
                <div className="mx-auto mb-5 sm:mb-6 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-neutral-50 shadow-sm">
                  <span className="text-2xl sm:text-3xl font-bold text-cefin-red">3</span>
                </div>
                <h3 className="mb-2 text-lg sm:text-xl font-bold text-neutral-900">
                  Lanzamiento
                </h3>
                <p className="text-sm sm:text-base text-neutral-600">
                  Ponemos todo en marcha para generar ventas
                </p>
              </div>
            </div>
          </div>
